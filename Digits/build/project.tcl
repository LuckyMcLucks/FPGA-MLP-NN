...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/uart_rx.sv" "./source/uart_tx.sv" "./source/counter.sv" "./source/looping_carry_save.sv" "./source/edge_detector.sv" "./source/pulse_extender.sv" "./source/relu.sv" "./source/mlp_module.sv" "./source/choose.sv" "./source/weights.sv" "./source/sigmoid.sv" "./source/output_neuron.sv" "./source/hidden_neuron.sv" "./source/input_neuron.sv" "./source/layer2.sv" "./source/layer3.sv" "./source/lucid_globals.sv" ]
